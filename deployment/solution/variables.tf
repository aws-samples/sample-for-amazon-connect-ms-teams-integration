...
variable "connect_stream_lambda_source_code_path" {
  ...
  default     = "../../connect-stream-lambda/src"
}
...
variable "connect_api_lambda_function_zip" {
  ...
  # Note: this file is generated by the archive_file data source during terraform apply.
  # The validation is intentionally removed because fileexists() is evaluated at plan time,
  # before the archive_file data source has produced the zip, causing a false failure.
}
