...
if [ -z "$AWS_PROFILE" -o \
    ...
    -z "$USER_CHAT_CLIENT_TYPE" -o \
    -z "$SLACK_APP_WORKSPACE_TOKEN" ]; then
    ...
    echo "  SLACK_APP_WORKSPACE_TOKEN"
    echo
...
echo "  SLACK_APP_WORKSPACE_TOKEN: ${SLACK_APP_WORKSPACE_TOKEN}"
...
lambda_environment_variables = {
  ...
  "SLACK_APP_WORKSPACE_TOKEN"      = "${SLACK_APP_WORKSPACE_TOKEN}"
}
EOF
